...
export class Post implements InMemoryDbService {
  ...
  { id: 1,
   ...
   content: 'After you have installing node and angular globaly on your devices, now we ready to install astronot angular, for first download source code on our repo https://github.com/Rafael-Lee1 , extract all file folder and open terminal run npm install for install astronot angular.'
   },
  { id: 2,
  name: 'Start' ,
